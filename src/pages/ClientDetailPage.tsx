      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5 flex items-start">
          ...
          <div>
            ...
            <p className="text-sm font-medium text-gray-900">{client.accountManager}</p>
          </div>
        </div>
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5 flex items-start">
          ...
          <div>
            ...
            <p className="text-sm font-medium text-gray-900">{client.analyst}</p>
          </div>
        </div>
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5 flex items-start">
          ...
          <div>
            ...
            <p className="text-sm font-medium text-gray-900">{client.cm}</p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4">
          {brands.map(brand => (
            <div 
              ...
              className="bg-white border flex items-center p-3 rounded-lg border-gray-200 hover:border-gray-300 hover:shadow-sm transition-all cursor-pointer group"
            >
